...
-- Contenido idéntico a supabase/migrations/*_create_rls_helpers.sql y
-- *_create_rls_policies.sql. La fuente de verdad para desplegar son las
-- migraciones; este archivo existe únicamente como documento de consulta.
-- ============================================================================
